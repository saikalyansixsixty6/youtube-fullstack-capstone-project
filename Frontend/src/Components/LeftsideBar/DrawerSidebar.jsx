...
import "./shorts-logo.png"
import {FaHistory} from "react-icons/fa"
import {NavLink} from "react-router-dom"

function DrawerSidebar({toggleDrawer,toggleDrawerSidebar}) {
  return (
  <div className="container_Drawer_Left_Sidebar" style={toggleDrawerSidebar}>
       <div className="container2_Drawer_Left_Sidebar">

           <div className="Drawer_left sidebar">
           ...
           <div className="libraryBtn_Drawer_left_sidebar">
       ...
       <div className="container3_Drawer_Left_Sidebar" onClick={()=>toggleDrawer()}></div>
